...
namespace Interface
{
    ...
    {    
        ...
        private void btnADD_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("A hora de saída não pode ser menor que a hora do atendimento", "Balance Sheet", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            else if (dtTimeOfService.Value == dtDepartureTime.Value)
            {
                MessageBox.Show("A hora de saída não pode ser igual a hora do atendimento", "Balance Sheet", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
